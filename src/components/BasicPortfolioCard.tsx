...
export const BasicPortfolioCard = ({
  ...
  return (
    ...
    >
      {/* Card container - Responsive Square shape */}
      <div className="relative w-full aspect-square bg-gradient-to-br from-[#0a0a0a] to-[#111111] rounded-lg border border-white/10 overflow-hidden transition-all duration-300 group-hover:border-white/30 group-hover:shadow-xl">
        ...
        <div className="px-2 xs:px-3 sm:px-4 md:px-6 pt-1 xs:pt-2 sm:pt-3 md:pt-4 text-center">
          ...
          <div className="hidden xs:flex items-center justify-center gap-1 text-[8px] xs:text-[10px] sm:text-xs text-gray-500 mt-0.5 xs:mt-1 sm:mt-2">
        ...
        {/* Badges - More compact */}
        <div className="absolute bottom-1 left-1 right-1 xs:bottom-2 xs:left-2 xs:right-2 sm:bottom-3 sm:left-3 sm:right-3 flex justify-center gap-0.5 xs:gap-1">
        ...
        {/* Hover action indicator - subtle */}
        <motion.div
          initial={{ opacity: 0 }}
          whileHover={{ opacity: 1 }}
          className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end justify-center pb-3 xs:pb-4 sm:pb-6 pointer-events-none rounded-lg"
        >
