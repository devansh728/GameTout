      ...
      <header className="fixed top-0 left-0 right-0 h-24 z-50 px-6 md:px-12 flex items-center justify-between gap-4 pointer-events-none">
        ...
        <div className="hidden lg:flex items-center justify-center gap-4 pointer-events-auto flex-1 min-w-0">
          ...
          <nav className="bg-black/90 backdrop-blur-xl border border-white/10 px-6 py-4 rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.5)] flex gap-6 items-center flex-shrink-0">
            ...
            >
              <button 
                className={`flex items-center gap-1.5 text-xs font-bold font-mono uppercase tracking-[0.2em] transition-colors ${
                  isVideoPath || isVideosDropdownOpen ? "text-[#FFAB00]" : "text-gray-400 hover:text-white"
                }`}
              >
          ...
          <AnimatePresence>
            {isPremium && subscriptionType && (
              ...
              >
                <motion.div
                  className={`group relative flex items-center gap-2 backdrop-blur-md border px-4 py-2.5 rounded-full overflow-hidden transition-all duration-300 ${
                ...
                >
                  ...
                  <motion.div
                    className={`relative w-6 h-6 rounded-full flex items-center justify-center ${
                      subscriptionType === "CREATOR" ? "bg-purple-500" : "bg-blue-500"
                    }`}
                    animate={{
                  ...
                  {/* Text */}
                  <span className={`relative text-[10px] font-bold font-mono uppercase tracking-wider transition-colors whitespace-nowrap ${
                    subscriptionType === "CREATOR"
                  ...
                  <Crown className={`w-3 h-3 ${
                    subscriptionType === "CREATOR" ? "text-purple-400" : "text-blue-400"
                  }`} />
                </motion.div>
              </motion.div>
            )}
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-4 overflow-y-auto flex-1">
              ...
              {isPremium && subscriptionType && (
                <div className={`flex items-center gap-3 py-3 px-4 rounded-lg border mt-4 ${
                  subscriptionType === "CREATOR"
                  ...
                  <Crown className={`w-5 h-5 ml-auto ${
                    subscriptionType === "CREATOR" ? "text-purple-400" : "text-blue-400"
                  }`} />
                </div>
              )}
